...
mod small_hash {
    ...
    pub(super) fn round(a: u64, b: u64, c: u64, d: &mut u64, e: u64, f: u64, g: u64, h: &mut u64, k: u64, w: u64) {
        let t1 = h.wrapping_add(Sigma1(e)).wrapping_add(Ch(e, f, g)).wrapping_add(k).wrapping_add(w);
        let t2 = Sigma0(a).wrapping_add(Maj(a, b, c));
        *d = d.wrapping_add(t1);
        *h = t1.wrapping_add(t2);
    }
    pub(super) fn later_round(a: u64, b: u64, c: u64, d: &mut u64, e: u64, f: u64, g: u64, h: &mut u64, k: u64, w: u64, w1: u64, w2: u64, w3: u64) -> u64 {
